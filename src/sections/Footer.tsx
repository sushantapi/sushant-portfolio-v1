...
export function Footer() {
  return (
    <footer className="border-t border-slate-200 bg-white py-8">
      <div className="section-shell flex flex-col gap-5 text-sm text-slate-500 sm:flex-row sm:items-center sm:justify-between">
        <div>
        ...
        <div className="flex flex-wrap items-center gap-4">
          ...
          <a href={`mailto:${siteConfig.email}`} className="transition hover:text-slate-900">Email</a>
        </div>
