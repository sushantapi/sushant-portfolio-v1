    ...
    <section id="top" className="section-shell grid min-h-[calc(100vh-4rem)] items-center gap-12 py-16 lg:grid-cols-[1.2fr_.8fr] lg:py-20">
      <div>
        ...
        <p className="mt-5 max-w-2xl text-base leading-8 text-zinc-400 sm:text-lg">
          Core focus: Java, Spring Boot, REST APIs, Microservices, Spring Security, and JPA/Hibernate.
        </p>

        <div className="mt-6 flex flex-wrap items-center gap-x-3 gap-y-2 text-sm font-medium text-zinc-300" aria-label="Experience and target role">
          <span>4.5 Years Experience</span>
          <span className="text-zinc-700" aria-hidden="true">·</span>
          <span>Targeting Senior Java Backend Roles</span>
        </div>
      ...
      <div className="card p-5 sm:p-6" aria-label="Core backend focus">
        ...
        <div className="mt-5 space-y-3 font-mono text-xs sm:text-sm">
          {backendFocus.map(([step, title, detail]) => (
