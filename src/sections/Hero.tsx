...
export function Hero() {
  return (
    <section id="top" className="section-shell grid min-h-[calc(100vh-4rem)] items-center gap-12 py-16 lg:grid-cols-[1.2fr_.8fr] lg:py-20">
      <div>
        <p className="hero-enter hero-delay-1 text-sm font-semibold tracking-wide text-green-300">{siteConfig.name}</p>
        ...
        <div className="hero-enter hero-delay-6 mt-8 flex flex-wrap gap-3">
          <a href="#projects" className="rounded-lg bg-green-400 px-5 py-3 text-sm font-semibold text-zinc-950 transition hover:bg-green-300">View My Work <span className="cta-arrow" aria-hidden="true">→</span></a>
          <a href="#contact" className="rounded-lg border border-white/12 bg-white/4 px-5 py-3 text-sm font-semibold text-zinc-100 transition hover:bg-white/8">Let's Talk <span className="cta-arrow" aria-hidden="true">→</span></a>
      ...
      <div className="hero-panel card p-5 sm:p-6" aria-label="Core backend focus">
        <div className="flex items-center justify-between border-b border-white/8 pb-4">
          <div>
            ...
            <p className="mt-1 text-sm text-zinc-400">What I work with most</p>
          </div>
          <span className="rounded-full border border-green-300/20 bg-green-300/8 px-2.5 py-1 text-xs text-green-200">Hands-on</span>
        </div>
