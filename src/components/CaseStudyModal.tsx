  ...
  return (
      <dialog ref={ref} className="m-auto max-h-[88vh] w-[min(760px,calc(100%-2rem))] overflow-y-auto rounded-2xl border border-slate-200 bg-white p-0 text-slate-900 shadow-2xl">
        ...
        <div className="space-y-7 px-5 py-6 sm:px-7 sm:py-8">
          ...
          <section>
            <h4 className="text-sm font-semibold text-slate-900">Backend Architecture</h4>
            <div className="mt-3 overflow-x-auto rounded-xl border border-slate-200 bg-slate-50 p-4 sm:p-6">
              <ArchitectureDiagram rows={caseStudy.architectureDiagram} ariaLabel={caseStudy.architecture} />
            </div>
          </section>
